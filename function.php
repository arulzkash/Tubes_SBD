...
function readBMI($id)
{
    ...
    if ($cekBMI == 0) {
        $query = "INSERT INTO t_bmi VALUES('', NULL, NULL, NULL, '$id')";
        $eksekusi = mysqli_query($conn, $query);
...
function updateDataBMI($data, $id)
{
    ...
    $query = "UPDATE t_bmi SET berat_badan = '$berat', tinggi_badan = $tinggiAsli, id_status_bmi = $status WHERE id_user = $id";
    $result = mysqli_query($conn, $query);
